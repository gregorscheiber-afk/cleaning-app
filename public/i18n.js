const TRANSLATIONS = {
  ...
  de: {
    ...
    assignmentTitle: 'Heutige Einteilung', assignmentBack: '← Übersicht',
  ...
  hr: {
    ...
    assignmentTitle: 'Današnja podjela', assignmentBack: '← Pregled',
  ...
  tr: {
    ...
    assignmentTitle: 'Bugünkü görevlendirme', assignmentBack: '← Genel bakış',
    aptCount: n => `${n} daire`,
  ...
  en: {
    ...
    assignmentTitle: "Today's assignment", assignmentBack: '← Overview',
    aptCount: n => `${n} apartment${n !== 1 ? 's' : ''}`,
