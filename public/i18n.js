const TRANSLATIONS = {
  de: {
    ...
    manualCheckin: 'Anreise (JJJJ-MM-TT)',
    manualCheckout: 'Abreise (JJJJ-MM-TT)',
    manualBookingAdd: 'Buchung hinzufügen',
    manualBadge: '✏️ Manuell',
    manualBooking: 'Ručno dodaj rezervaciju',
    manualBookingHint: 'Za uzastopne rezervacije na isti dan',
    manualCheckin: 'Dolazak (GGGG-MM-DD)',
    manualCheckout: 'Odlazak (GGGG-MM-DD)',
    manualBookingAdd: 'Dodaj rezervaciju',
    manualBadge: '✏️ Ručno',
    manualBooking: 'Rezervasyon ekle',
    manualBookingHint: 'Aynı günde ardışık rezervasyonlar için',
    manualCheckin: 'Giriş (YYYY-AA-GG)',
    manualCheckout: 'Çıkış (YYYY-AA-GG)',
    manualBookingAdd: 'Rezervasyon ekle',
    manualBadge: '✏️ Manuel',
    manualBooking: 'Add booking manually',
    manualBookingHint: 'For back-to-back bookings on the same day',
    manualCheckin: 'Check-in (YYYY-MM-DD)',
    manualCheckout: 'Check-out (YYYY-MM-DD)',
    manualBookingAdd: 'Add booking',
    manualBadge: '✏️ Manual',
