...
async function initDb() {
  ...
  // Art der Info: 'normal' oder 'update' (App-Neuerung – sieht anders aus)
  await pool.query(`ALTER TABLE reinigung_infos ADD COLUMN IF NOT EXISTS kind TEXT DEFAULT 'normal'`);
